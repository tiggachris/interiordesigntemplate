      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <h1 className="font-serif text-5xl mb-6">Let's Talk.</h1>
            <p className="text-gray-500 mb-12">
              Ready to transform your space? Schedule a consultation with our
              lead designers.
            </p>
            ...
            <form className="space-y-6 mb-16">
              <div className="grid grid-cols-2 gap-6">
                <input
                  ...
                  className="w-full bg-transparent border-b border-gray-300 py-3 outline-none focus:border-matteBlack transition-colors"
                />
                <input
                  type="text"
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-transparent border-b border-gray-300 py-3 outline-none focus:border-matteBlack transition-colors resize-none"
              ></textarea>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-500 ml-8">
                  124 Luxury Ave, Design District, NY 10001
                </p>
              </div>
              <div>
                <div className="flex items-center gap-3 mb-2 text-[#D4AF37]">
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-12">
            <div className="h-[400px] w-full bg-gray-200 relative overflow-hidden group">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3656.676822165711!2d87.18708257504362!3d23.580047795295524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f713003c10a171%3A0xc73f8276f9b85421!2sBlue%20eves%20apartment!5e0!3m2!1sen!2sin!4v1778326184110!5m2!1sen!2sin"
                width="100%"
                height="100%"
                ...
                {faqs.map((faq, idx) => (
                  <div key={idx} className="border-b border-gray-300 pb-4">
                    <button
                      ...
                      className="w-full text-left flex justify-between items-center font-bold"
                    >
                      {faq.q}
